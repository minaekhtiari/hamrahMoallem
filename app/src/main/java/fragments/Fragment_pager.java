...
import apps.hillavas.com.hamrahdars.ChangeStateActivity;
import apps.hillavas.com.hamrahdars.CommonFragment;
import apps.hillavas.com.hamrahdars.ConsultantActivity;
import apps.hillavas.com.hamrahdars.CustPagerTransformer;
import apps.hillavas.com.hamrahdars.MessagingActivity;
import apps.hillavas.com.hamrahdars.NewsActivity;
...
import static apps.hillavas.com.hamrahdars.R.id.all;
import static apps.hillavas.com.hamrahdars.R.id.toolbar_home_imageMessage;
...
//                        if(frameMenu.getVisibility() == View.INVISIBLE)
    ...
    private void fillViewPager(final int size) {
        ...
        viewPager.setPageTransformer(false, new CustPagerTransformer(getActivity()));
            ...
            public Fragment getItem(int position) {
                CommonFragment fragment = fragments.get(position % allRecords.size());
...
//                        records = null;}
        ...
        protected void onPostExecute(List<Record> records) {
            ...
            if(records != null && records.size() > 0){
                ...
                if ((RelativeLayout) getActivity().findViewById(R.id.activity_main_relative) != null) {
