...
public class MenuActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvNewAnswerCount = (TextView) findViewById(R.id.toolbar_home_text_newMessageCount);
        ivNewAnswerCountBack = (ImageView) findViewById(R.id.toolbar_home_image_newMessageCountBack);
